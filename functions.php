...
X-WR-CALNAME;VALUE=TEXT:$siteName $filterWhere
...
EOD;
    ...
    header("Content-Disposition: attachment; filename=calendar_" . strtolower(str_replace(" ", "", $filterWhere)) . ".ics;");
...
function emitIcal($a)
{
    ...
    $uid = md5($a['what'] . $a['where']) . "@helaaspindakaas.xyz";
    $what = icalTxt($a['what']);
